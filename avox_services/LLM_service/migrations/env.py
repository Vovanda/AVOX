...
from llm_service.app.models import *  # noqa
from llm_service.app.models.base import Base
...
def run_migrations_online():
    ...
    with connectable.connect() as connection:
        ...
        with context.begin_transaction():
            connection.execute(text("CREATE SCHEMA IF NOT EXISTS llm"))
            context.run_migrations()
